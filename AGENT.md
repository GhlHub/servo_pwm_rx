...
- Keep `ip_repo/servo_pwm_rx/component.xml` and `drivers/servo_pwm_rx_v1_0/data/servo_pwm_rx.mdd` version numbers aligned when bumping the packaged IP version
